        ...
        "pre" => {
            ...
            View::new(view! {
                <pre
                    ...
                    class="overflow-x-auto overflow-y-auto overscroll-y-auto overscroll-x-contain my-2 rounded-md py-3.5 px-4 min-w-0 text-xs outline-none no-scrollbar bg-muted"
                >
                    {children}
                </pre>
            }.into_any())
